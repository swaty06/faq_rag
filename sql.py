...
db_path = Path(__file__).parent / "books.sqlite3"
...
price - float (price of the book in Euros)	
	
rating - float ( rating of the book. Range 0-5, 5 is the highest.)	
total_ratings - integer (total number of ratings for the book)

</schema>
Make sure whenever you try to search for the book name, the name can be in any case. 
So, make sure to use %LIKE% to find the book in condition. Never use "ILIKE". 
...
Produt title, price in euros, discount, and rating, and then product link. Take care that all the products are listed in list format, one line after the other. Not as a paragraph.
For example:
1. Return of the Spider: An Alex Cross Thriller: €995 , Rating: 4.4 <link>
2. Return of the Spider: An Alex Cross Thriller: €995 , Rating: 4.4 <link>
3. Return of the Spider: An Alex Cross Thriller: €995 , Rating: 4.4 <link>
